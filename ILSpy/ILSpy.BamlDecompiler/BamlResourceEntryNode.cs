...
{
	public sealed class BamlResourceEntryNode
	{
        public BamlResourceEntryNode(AssemblyDefinition asm, Stream data)
        {
            LoadBaml(asm, data);
        }
        ...
        bool LoadBaml(AssemblyDefinition asm, Stream data)
		{
			data.Position = 0;
			XDocument xamlDocument = LoadIntoDocument(GlobalAssemblyResolver.Instance, asm, data);
